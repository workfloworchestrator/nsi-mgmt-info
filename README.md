...
`dynamic = ["version"]` and setuptools-scm derives it: a tag builds `0.1.2`, any other commit builds
the next patch as a dev release with its commit, `0.1.3.dev3+g1a2b3c4`. AMISS logs that version at
