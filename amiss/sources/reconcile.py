...
class StpRow(BaseModel):
    ...
    vlan_range: str | None = None
    description: str | None = None
    switching_service_id: str | None = (
        None  # Arno: note that this has the same domain-specific prefix as the stp_id, so that alone could be used to sort by SwitchingService/domain/toplogy.
    )
